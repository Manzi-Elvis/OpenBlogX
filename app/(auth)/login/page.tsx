        ...
        <div className="container-wide w-full">
          <div className="max-w-md mx-auto py-12">
            ...
            <div className="space-y-2 mb-8">
              ...
              <p className="text-body text-foreground-light">Enter your credentials to access your account.</p>
            </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-background text-foreground-light">Or continue with</span>
              </div>
            </div>

            {/* OAuth buttons */}
            <div className="space-y-3">
              <button className="w-full flex items-center justify-center gap-2 rounded-lg border border-border bg-card hover:bg-card/80 transition-colors px-4 py-3 font-medium">
